...
public class JSONObjectToTableGenerator extends HumanInterfaceGenerator {
		...
		public JSONObject process(JSONObject data, int currentActionIndex) {
			...
			String visualizationStyle = data.getString(TeleonomeConstants.DENEWORD_TYPE_PANEL_VISUALIZATION_STYLE);
